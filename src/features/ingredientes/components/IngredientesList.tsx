...
export function IngredientesList() {
    ...
    const handleRecargar = async () => {
        ...
        setTimeout(() => setIsRefreshing(false), 500); // Pequeña pausa para mejor UX
    };

    const handleNuevoIngrediente = () => {
        setIsAddingIngredient(true);
        // El loader se mantendrá hasta que se navegue a la nueva página
    };
        ...
        return (
            <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4">
                <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center space-y-4">
                    <Loader size="lg" />
                    <p className="text-gray-600 text-lg font-medium">Cargando ingredientes...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 space-y-4 sm:space-y-0">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Gestiona todos tus ingredientes de manera eficiente
                            </p>
                        </div>
                ...
                {ingredientes.length === 0 ? (
                    <div className="text-center py-16">
                        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto">
                            ...
                            <p className="text-gray-600 mb-6">Comienza agregando tu primer ingrediente para gestionar tu inventario.</p>
                            <Link 
                                href="/ingredientes/new"
                        ...
                        {ingredientes.map((ingrediente, index) => (
                            ...
                            >
                                <IngredienteCard 
                                    ...
                                    onDelete={() => eliminarIngrediente(ingrediente.ingrediente_id)}
                                />
                            </div>
                        ))}
                    </div>
